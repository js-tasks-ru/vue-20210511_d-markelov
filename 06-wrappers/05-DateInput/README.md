...
Для начала требуется передать на **input** корректное строковое `value`, а зависимости от значения `value` у компонента. Это вычисление можно поместить в вычисляемое свойство
...
Добавим простой метод, который будет обработчиком нативного события `input`. В зависимости от типа входного параметра вернём введенное значение в нужном формате.
